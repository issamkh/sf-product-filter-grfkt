...
class ProductRepository extends ServiceEntityRepository
{
    ...
    */
    ...
    /**
     * Récupére les produits avec une recherche
     *
    ...
    /**
     * Récupère le prix min et max correspond à une recherche
    ...
    public function getSearchQuery(SearchData $search, $ignorePrice = false): QueryBuilder {
        ...
        $query = $this
            ...
            //----- un seul select pour les categories et produits
            ->select('c', 'p')
            ->join('p.categories', 'c');
